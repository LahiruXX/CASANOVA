            ...
            <form className="needs-validation" noValidate>
              ...
              <div className="form-group" style={{ marginBottom: '15px' }}>
                ...
                {/* <input type = "text"
                        ...
                        onChange={this.handleInputChange}/> */}
                <select name="cusStatus" class="c-form-profession form-control" id="c-form-profession" value={this.state.cusStatus} onChange={this.handleInputChange} >
                  <option value="">Select a Customer Status</option>
